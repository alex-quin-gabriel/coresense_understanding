...
class GetRangeModeletNode : public BT::RosServiceNode<triplestar_msgs::srv::SelectQuery>
{
public:
  explicit GetRangeModeletNode(const std::string& name, const BT::NodeConfig& config,
  ...
  {    
    return providedBasicPorts({ 
        ...
        BT::OutputPort<sensor_msgs::msg::Range>(
            "modelet",
            "Retrieved modelet")
        });
  }
